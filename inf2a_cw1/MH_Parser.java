...
// Java template file for parser component of Informatics 2A Assignment 2 (2012).
...
class MH_Parser extends GenParser implements PARSER {
    ...
    String[] tableEntry (String nonterm, String tokClass) {
    	if (nonterm.equals("#Prog")) {
    		...
    		if (tokClass == null) {
    			return epsilon;
    		} else if (tokClass.equals("Integer") || tokClass.equals("Bool") ||
    				tokClass.equals("(")) {
    		...
    		if (tokClass == null || tokClass.equals(")") ||
    				tokClass.equals(";")) {
    			return epsilon;
    		} else if (tokClass.equals("->")) {
    			return arrow_Type;
    		...
    		if (tokClass == null) {
    			return epsilon;
    		} else if (tokClass.equals("VAR") || tokClass.equals("NUM") ||
    				tokClass.equals("BOOLEAN") || tokClass.equals("(")) {
    			return Exp1;
    		...
    		if (tokClass == null || tokClass.equals("then") ||
    				tokClass.equals("else") || tokClass.equals(")") ||
    				tokClass.equals(";")) {
    			return epsilon;
    		} else if (tokClass.equals("==")) {
    			return eq_rule;
    		...
    		if (tokClass == null || tokClass.equals(")") ||
    				...
    				tokClass.equals("<") || tokClass.equals("then") ||
