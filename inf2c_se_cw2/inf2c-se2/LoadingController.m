...
// Informatics 2C - Software Engineering 2012
// Mark Nemec - s1140740
// Contribution for Assignment 2 start

// If the device is an iPhone with iOS 6 or latter,
// use UIActivityViewController with the URL of the source and
// disable sharing to printer, Facebok, Weibo and camera roll
// else invoke the old UIActionSheet
- (void)actionTapped {
...
// Contribution for Assignment 2 end
